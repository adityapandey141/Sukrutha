...
const testimonials = [
  ...
  {
    quote:
      "What sets them apart is their understanding of our needs. They don't just supply — they partner with us to improve patient outcomes.",
    name: "Dr. Deepak Kumar M.M.",
    role: "Orthopedic Surgeon (M.B.B.S., M.S. Ortho, DNB)",
    location: "Karnataka",
  },
  {
    quote:
      "In 15 years of association, not once has Sukrutha Healthcare let us down on a critical supply. That kind of trust is rare in this industry.",
    name: "Dr. Bojovu Kumar",
    role: "Pediatrician (M.B.B.S., M.D.)",
    location: "Karnataka",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative bg-medic-gray-bg rounded-3xl p-8 md:p-12">
            <Quote
              size={48}
              className="text-medic-teal/20 absolute top-6 left-6"
            />
